(let ((dummy-procedure (foreign-function "build/libexample.so" "dummy_procedure")))
  (check (foreign-function? dummy-procedure) => #t)
  )

(let ((length-of-arguments (foreign-function "build/libexample.so" "length_of_arguments")))
