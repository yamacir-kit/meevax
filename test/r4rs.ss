...
(check (memq 101 '(100 101 102)) => '(101 102)) ; unspecified
...
(check (assq 5 '((2 3) (5 7) (11 13))) => '(5 7)) ; unspecified
...
; (check (string->number "15##") => 1500.0) ; This feature was obsoleted in R7RS.
