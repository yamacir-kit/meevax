...
inline namespace kernel
{
  ...
  namespace string_to
  {
    ...
    auto integer = [](std::string const& token, auto radix = 10) -> value_type
    {
    ...
    auto decimal = [](std::string const& token, auto) -> value_type
    {
  ...
  public:
    ...
    inline auto read(std::string const& s) -> value_type
    {
