...
; pression types in terms of the primitive expression types
...
; the value stored in the location. (No such expression is de-
...
; in promises iteratively using a trampoline technique fol-
; lowing [38] until a non-lazy result (i.e. a value created by
...
; threads. Parameter objects are implemented here as pro-
...
; Then parameterize uses dynamic-wind to dynamically re-
...
; iliary macro, here called guard-aux.
...
(define-syntax cond-expand
  ...
  (syntax-rules (and or not else r7rs library scheme base)
    ...
    ((cond-expand (r7rs body ...)
                  more-clauses ...)
     (begin body ...))
    ;; Add clauses here for each supported feature identifier.
    ;; Samples:
