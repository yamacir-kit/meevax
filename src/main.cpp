...
int main() try
{
  ...
  meevax::cairo::surface surface {connection};
  {
    ...
    surface.change_attributes(XCB_CW_EVENT_MASK, XCB_EVENT_MASK_EXPOSURE);
  }
  xcb_flush(connection);

  for (std::shared_ptr<xcb_generic_event_t> event {nullptr}; event.reset(xcb_wait_for_event(connection)), event; xcb_flush(connection))
  {
