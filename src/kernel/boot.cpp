...
namespace meevax::inline kernel
{
  auto resolve(char const* name) -> void *
  {
    ...
    auto static const registry = std::unordered_map<std::string, procedure::signature>
    {
      ...
      { "binary64-max",                  [](let const& xs) { auto max = -std::numeric_limits<double>::infinity(); for (let const& x : xs) { max = std::fmax(max, x.as<double>()); } return make<double>(max); } },
      { "binary64-min",                  [](let const& xs) { auto min = std::numeric_limits<double>::infinity(); for (let const& x : xs) { min = std::fmin(min, x.as<double>()); } return make<double>(min); } },
      ...
      { "char=?",                        [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), [](let const& a, let const& b) { return not (a.as<character>().codepoint == b.as<character>().codepoint); }) == xs.end()); } },
      { "char<?",                        [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), [](let const& a, let const& b) { return not (a.as<character>().codepoint < b.as<character>().codepoint); }) == xs.end()); } },
      { "char<=?",                       [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), [](let const& a, let const& b) { return not (a.as<character>().codepoint <= b.as<character>().codepoint); }) == xs.end()); } },
      { "char>?",                        [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), [](let const& a, let const& b) { return not (a.as<character>().codepoint > b.as<character>().codepoint); }) == xs.end()); } },
      { "char>=?",                       [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), [](let const& a, let const& b) { return not (a.as<character>().codepoint >= b.as<character>().codepoint); }) == xs.end()); } },
      { "char-ci=?",                     [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), [](let const& a, let const& b) { return not (a.as<character>().downcase() == b.as<character>().downcase()); }) == xs.end()); } },
      { "char-ci<?",                     [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), [](let const& a, let const& b) { return not (a.as<character>().downcase() < b.as<character>().downcase()); }) == xs.end()); } },
      { "char-ci<=?",                    [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), [](let const& a, let const& b) { return not (a.as<character>().downcase() <= b.as<character>().downcase()); }) == xs.end()); } },
      { "char-ci>?",                     [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), [](let const& a, let const& b) { return not (a.as<character>().downcase() > b.as<character>().downcase()); }) == xs.end()); } },
      { "char-ci>=?",                    [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), [](let const& a, let const& b) { return not (a.as<character>().downcase() >= b.as<character>().downcase()); }) == xs.end()); } },
      ...
      { "environment",                   [](let const& xs) { auto e = make<environment>(); for (let const& x : xs) { e.as<environment>().import(x); } return e; } },
      ...
      { "=",                             [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), not_equals) == xs.end()); } },
      { "<",                             [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), greater_than_or_equals) == xs.end()); } },
      { "<=",                            [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), greater_than) == xs.end()); } },
      { ">",                             [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), less_than_or_equals) == xs.end()); } },
      { ">=",                            [](let const& xs) { return make<bool>(std::adjacent_find(xs.begin(), xs.end(), less_than) == xs.end()); } },
      ...
      { "string=?",                      [](let const& xs) { auto compare = [](let const& a, let const& b) { return not (a.as<string>() == b.as<string>()); }; return make<bool>(std::adjacent_find(xs.begin(), xs.end(), compare) == xs.end()); } },
      { "string<?",                      [](let const& xs) { auto compare = [](let const& a, let const& b) { return not (a.as<string>() < b.as<string>()); }; return make<bool>(std::adjacent_find(xs.begin(), xs.end(), compare) == xs.end()); } },
      { "string>?",                      [](let const& xs) { auto compare = [](let const& a, let const& b) { return not (a.as<string>() > b.as<string>()); }; return make<bool>(std::adjacent_find(xs.begin(), xs.end(), compare) == xs.end()); } },
      { "string<=?",                     [](let const& xs) { auto compare = [](let const& a, let const& b) { return not (a.as<string>() <= b.as<string>()); }; return make<bool>(std::adjacent_find(xs.begin(), xs.end(), compare) == xs.end()); } },
      { "string>=?",                     [](let const& xs) { auto compare = [](let const& a, let const& b) { return not (a.as<string>() >= b.as<string>()); }; return make<bool>(std::adjacent_find(xs.begin(), xs.end(), compare) == xs.end()); } },
      { "string-ci=?",                   [](let const& xs) { auto compare = [](let const& s1, let const& s2) { auto compare = [](auto const& c1, auto const& c2) { return c1.downcase() == c2.downcase(); }; return not std::lexicographical_compare(s1.as<string>().characters.begin(), s1.as<string>().characters.end(), s2.as<string>().characters.begin(), s2.as<string>().characters.end(), compare); }; return make<bool>(std::adjacent_find(xs.begin(), xs.end(), compare) == xs.end()); } },
      { "string-ci<?",                   [](let const& xs) { auto compare = [](let const& s1, let const& s2) { auto compare = [](auto const& c1, auto const& c2) { return c1.downcase() < c2.downcase(); }; return not std::lexicographical_compare(s1.as<string>().characters.begin(), s1.as<string>().characters.end(), s2.as<string>().characters.begin(), s2.as<string>().characters.end(), compare); }; return make<bool>(std::adjacent_find(xs.begin(), xs.end(), compare) == xs.end()); } },
      { "string-ci>?",                   [](let const& xs) { auto compare = [](let const& s1, let const& s2) { auto compare = [](auto const& c1, auto const& c2) { return c1.downcase() > c2.downcase(); }; return not std::lexicographical_compare(s1.as<string>().characters.begin(), s1.as<string>().characters.end(), s2.as<string>().characters.begin(), s2.as<string>().characters.end(), compare); }; return make<bool>(std::adjacent_find(xs.begin(), xs.end(), compare) == xs.end()); } },
      { "string-ci<=?",                  [](let const& xs) { auto compare = [](let const& s1, let const& s2) { auto compare = [](auto const& c1, auto const& c2) { return c1.downcase() <= c2.downcase(); }; return not std::lexicographical_compare(s1.as<string>().characters.begin(), s1.as<string>().characters.end(), s2.as<string>().characters.begin(), s2.as<string>().characters.end(), compare); }; return make<bool>(std::adjacent_find(xs.begin(), xs.end(), compare) == xs.end()); } },
      { "string-ci>=?",                  [](let const& xs) { auto compare = [](let const& s1, let const& s2) { auto compare = [](auto const& c1, auto const& c2) { return c1.downcase() >= c2.downcase(); }; return not std::lexicographical_compare(s1.as<string>().characters.begin(), s1.as<string>().characters.end(), s2.as<string>().characters.begin(), s2.as<string>().characters.end(), compare); }; return make<bool>(std::adjacent_find(xs.begin(), xs.end(), compare) == xs.end()); } },
