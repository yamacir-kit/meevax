...
inline namespace kernel
{
  ...
  auto operator % (exact_integer const&  , ratio const&  ) -> ratio { throw make<error_>(make<string>("unsupported operation"), unit); }
  ...
  auto operator % (ratio const&  , exact_integer const&  ) -> ratio { throw make<error_>(make<string>("unsupported operation"), unit); }
  ...
  auto operator % (ratio const&  , ratio const&  ) -> ratio   { throw make<error_>(make<string>("unsupported operation"), unit); }
