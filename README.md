...
|:-------------------|:--
| `all` (default)    | Build shared-library `libmeevax.0.3.625.so` and executable `meevax`.
| `test`             | Test executable `meevax`.
| `package`          | Generate debian package `meevax_0.3.625_amd64.deb`.
...
```
Meevax Lisp System, version 0.3.625
