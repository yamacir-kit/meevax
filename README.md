...
| Target      | Description
|-------------|-------------
| `all`       | Build shared-library `libmeevax.0.5.581.so` and executable `meevax`.
| `install`   | Copy files into `/usr/local` directly.
| `package`   | Generate debian package `meevax_0.5.581_amd64.deb` (only Ubuntu). The generated package can be installed by `sudo apt install build/meevax_0.5.581_amd64.deb`.
