...
cd build
make package
sudo apt install build/meevax_0.5.179_amd64.deb
```
...
|-------------|-------------
| `all`       | Build shared-library `libmeevax.0.5.179.so` and executable `meevax`
| `test`      | Test executable `meevax`
| `package`   | Generate debian package `meevax_0.5.179_amd64.deb`
