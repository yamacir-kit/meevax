...
cd build
make package
sudo apt install build/meevax_0.4.771_amd64.deb
```
...
|-----------------|-------------
| `all` (default) | Build shared-library `libmeevax.0.4.771.so` and executable `meevax`
| `test`          | Test executable `meevax`
| `package`       | Generate debian package `meevax_0.4.771_amd64.deb`
