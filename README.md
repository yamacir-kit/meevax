...
|:-------------------|:--
| `all` (default)    | Build shared-library `libmeevax.0.3.743.so` and executable `meevax`.
| `test`             | Test executable `meevax`.
| `package`          | Generate debian package `meevax_0.3.743_amd64.deb`.
...
```
Meevax Lisp System, version 0.3.743
