...
|:-------------------|:--
| `all` (default)    | Build shared-library `libmeevax.0.4.73.so` and executable `meevax`.
| `test`             | Test executable `meevax`.
| `package`          | Generate debian package `meevax_0.4.73_amd64.deb`.
...
```
Meevax Lisp System, version 0.4.73
