...
|:-------------------|:--
| `all` (default)    | Build shared-library `libmeevax.0.4.46.so` and executable `meevax`.
| `test`             | Test executable `meevax`.
| `package`          | Generate debian package `meevax_0.4.46_amd64.deb`.
...
```
Meevax Lisp System, version 0.4.46
